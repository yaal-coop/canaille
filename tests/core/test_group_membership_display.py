...
def test_moderator_sees_groups_they_belong_to(testclient, logged_moderator, foo_group, bar_group, backend):
...
def test_moderator_can_click_all_groups_because_of_manage_groups_permission(testclient, logged_moderator, foo_group, bar_group):
...
def test_admin_user_can_see_and_click_all_groups(testclient, logged_admin, foo_group, bar_group):
...
def test_group_linking_behavior_works(testclient, logged_moderator, foo_group, bar_group):
...
def test_icons_are_clickable_for_admin_users(testclient, logged_admin, foo_group, bar_group):
