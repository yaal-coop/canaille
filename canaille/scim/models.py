...
group_schema.get_attribute("displayName").required = Required.true
group_schema.get_attribute("members").required = Required.true
group_schema.get_attribute("members").get_attribute("value").required = Required.true
group_schema.get_attribute("members").get_attribute("$ref").required = Required.true
